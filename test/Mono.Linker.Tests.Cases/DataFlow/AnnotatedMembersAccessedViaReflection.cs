...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	class AnnotatedMembersAccessedViaReflection
	{
		...
		class AnnotatedField
		{
			...
			[ExpectedWarning ("IL2109", nameof (_annotatedField))]
		...
		class AnnotatedMethodParameters
		{
			...
			[ExpectedWarning ("IL2110", nameof (MethodWithSingleAnnotatedParameter))]
			static void Reflection ()
			{
			...
			[ExpectedWarning ("IL2110", nameof (IWithAnnotatedMethod.AnnotatedMethod))]
		...
		class AnnotatedMethodReturnValue
		{
			...
			[ExpectedWarning ("IL2110", nameof (MethodWithAnnotatedReturnValue))]
			static void Reflection ()
			{
		...
		class AnnotatedProperty
		{
			...
			[ExpectedWarning ("IL2110", nameof (PropertyWithAnnotation))]
			...
			[ExpectedWarning ("IL2110", nameof (PropertyWithAnnotationGetterOnly))]
			...
			[ExpectedWarning ("IL2110", nameof (PropertyWithAnnotation) + ".get")]
			static void ReflectionOnGetter ()
			{
				typeof (AnnotatedProperty).GetMethod ("get_" + nameof (PropertyWithAnnotation));
			}

			[ExpectedWarning ("IL2110", nameof (PropertyWithAnnotation) + ".set")]
			...
			[ExpectedWarning ("IL2110", nameof (PropertyWithAnnotation) + ".get")]
			[ExpectedWarning ("IL2110", nameof (PropertyWithAnnotation) + ".set")]
			[ExpectedWarning ("IL2110", nameof (PropertyWithAnnotationGetterOnly) + ".get")]
		...
		class AnnotationOnGenerics
		{
			...
			[ExpectedWarning ("IL2110", nameof (GenericWithAnnotatedMethod<TestType>.AnnotatedMethod))]
			...
			[ExpectedWarning ("IL2110", nameof (GenericMethodWithAnnotation))]
		...
		class AnnotationOnInteropMethod
		{
			...
			[ExpectedWarning ("IL2109", nameof (ValueWithAnnotatedField._typeField))]
		...
		class AccessThroughLdToken
		{
			...
			[ExpectedWarning ("IL2110", nameof (PropertyWithLdToken))]
			public static void Test ()
			{
